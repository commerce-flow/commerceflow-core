...
// const inter = Open_Sans({ subsets: ['latin'], style: 'normal', weight:'400' });
...
export default function Home() {
  ...
  console.log({ hello });
  return (
    <main className={`flex min-h-screen flex-col items-center justify-between p-24 ${roboto_mono.variable}`}>
