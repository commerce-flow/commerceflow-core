    ...
    <>
      ...
      <ol className='list-decimal list-inside mb-10 mt-10 text-sm'>
        <li className='pb-2 text-sm'>
          Create a personal access token. Note: You should either set the token to not expire or set a long expiry date, by which you will need to provide a new
          token when this one has expired. CommerceFlow will inform you if the token has expired
          <div className='w-full text-center mt-4 mb-2'>
            <a target='_blank' href='https://vercel.com/docs/rest-api#creating-an-access-token' className='text-blue-300'>
        ...
        <li className='pb-2 mb-4 text-sm'>
          Note that you must revoke the access token if you remove or stop using CommerceFlow. You can delete on your tokens page here:
          <div className='w-full text-center mt-2'>
            <a target='_blank' href='https://vercel.com/account/tokens' className='text-blue-300'>
              {' '}
