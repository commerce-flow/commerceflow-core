...
const Instructions2 = ({
  ...
  return (
    <>
      ...
      <p className='font-light text-gray-500 dark:text-gray-400 text-sm mb-4'>
        {`CommerceFlow will handle creating and updating extensions for you. But to do that, you need to create a github account and get an access token manually which CommerceFlow will use in managing your extensions. Please follow the instructions from the link below: `}
      </p>
      <ol className='list-decimal list-inside mb-10 mt-10 text-sm'>
        ...
        <li className='pb-2 mb-4 text-sm'>
          ...
          then select both Content and workflow, give both of them the Read and Write permission. <br /> Note: Make sure you only select the repository you just
          created when giving repository access. Also, select at least 90days or longer. CommerceFlow will inform you once the token expires so you can generate
          another.
